...
class HexacotperHandler(web.RequestHandler):
    ...
    def patch(self, id):
        ...
        if ('motor_speed' not in request_data.keys()) or (request_data['motor_speed'] is None):
        ...
        try:
            ...
            response = {'speed': hexacopter_status.motor_speed, 'turned_on': hexacopter_status.turned_on,}
            self.set_status(status.HTTP_200_OK)
            self.write(response)
...
application = web.Application([
        (r"/hexacopters/([0-9]+)", HexacotperHandler),
